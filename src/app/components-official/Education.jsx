              ...
              >
                ...
                <div className="px-5 pt-4">
                  <span className="inline-block bg-[#b33b3b]/10 text-[#b33b3b] text-xs font-semibold px-3 py-1 rounded-full">
                    {viewModal.category || "Uncategorized"}
                  </span>
                </div>
                  ...
                  <div className="p-4">
                    {viewModal.media_type?.startsWith("video/") ? (
                      <video
                        ...
                        controls
                        className="w-full max-h-[250px] sm:max-h-[350px] rounded-xl border border-gray-200 shadow-sm"
                      />
                    ) : viewModal.media_type?.startsWith("image/") ? (
                      <img
                        src={viewModal.media_url}
                        alt="Educational media"
                        className="w-full max-h-[250px] sm:max-h-[350px] rounded-xl border border-gray-200 shadow-sm object-cover"
                      />
                    ) : null}
                  </div>
                )}
